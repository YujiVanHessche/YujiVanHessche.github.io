...
// const rendertasks = () => {
//     const hoofd = document.getElementById("titelbox").value.trim();
//     const desc = document.getElementById("onderwerpbox").value.trim()
//     const taskDiv = createElementWithClassName("div","task");
//     const titel = createElementWithClassNameAndText("p","titel",hoofd)
//     const onderwerp = createElementWithClassNameAndText("p","onderwerp",desc);
//     const datum = createElementWithClassNameAndText("p","datum",new Date())
//     ['todo','inprogress','done'].foreach(status){
//         const div = document.getElementById(status);
//     }
//     div.appendChild(taskDiv);
//     taskDiv.appendChild(titel);
//     taskDiv.appendChild(onderwerp);
//     taskDiv.appendChild(datum);
//     taskDiv.draggable = true;
//     taskDiv.id = tasks.createdAt;
//     tasks
